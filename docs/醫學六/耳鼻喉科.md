...
- 定義：**角化鱗狀上皮**在中耳/乳突異常堆積 → 慢性炎症 + 骨侵蝕（非真正腫瘤）
- 分類：
...
- 耳漏：**惡臭**為特徵
- 併發症（因骨侵蝕）：
    - 聽小骨破壞 → 傳導性聽損（**incus 長突**最常被侵蝕）
    - 顏面神經暴露/麻痺
    - 迷路瘻管（labyrinthine fistula）→ 眩暈（**外側半規管**最常受侵犯）
...
### 3.12 突發性感音性聽損（Sudden SNHL, SSNHL）
...
- **喉返神經（Recurrent Laryngeal Nerve, RLN）**：迷走神經分支
    - 支配除環甲肌以外的**所有喉內肌**（包括唯一的外展肌 posterior cricoarytenoid）
...
- 好發：用聲過度者（教師、歌手、小兒）
- 位置：**雙側**聲帶前中 1/3 交界處（membranous vocal fold 的中點）
...
- 治療：
    - 早期：**放射治療**或**雷射切除（transoral laser microsurgery）** → 保留喉部功能
...
- **Plummer-Vinson syndrome**：缺鐵性貧血 + 吞嚥困難（esophageal web）+ 舌炎 → 增加**環咽後區（postcricoid）下咽癌**風險
