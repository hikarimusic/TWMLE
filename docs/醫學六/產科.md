...
- **處理原則**：
    ...
    - 無嚴重特徵 + ≥37 週：建議終止妊娠
    - 有嚴重特徵 + ≥34 週：終止妊娠
    - 有嚴重特徵 + <34 週：可考慮**期待療法（expectant management）**
...
- **E**levated **L**iver enzymes（AST/ALT ↑）
...
- **Complete mole（完全性葡萄胎）**：
    ...
    - 併發症：子癇前症（<20 週即出現的 preeclampsia 要想到 mole）、甲亢（hCG 與 TSH 結構相似）、卵巢黃體囊腫（hCG 刺激卵巢）
...
- **首選**：**Penicillin G**（或 Ampicillin）
    - Penicillin 過敏低風險：Cefazolin
    - Penicillin 過敏高風險：Clindamycin 或 Vancomycin
...
- DVT 好發**左側**（左髂靜脈被右髂動脈壓迫 = May-Thurner）
...
- **Peripartum cardiomyopathy**：
    ...
    - 治療：標準心衰竭治療（但 ACEi/ARB 於產後才能用）
        — 妊娠期用 Hydralazine + Nitrate
...
- 定義：葡萄胎或任何妊娠後，滋養層細胞發生**惡性增生**，統稱 GTN
- 診斷線索：
