...
- **Krukenberg tumor**：轉移性卵巢腫瘤；最常從**胃癌**轉移（signet ring cells）；通常雙側
...
| 類型 | 特徵 | 惡性比例 |
|------|------|----------|
| **Serous** | **最常見**上皮性腫瘤；**時常雙側**；可有 psammoma bodies；多與 TP53 mutation 相關；現認為起源自輸卵管繖部（fimbria） | 惡性多 |
| Mucinous | 可長很大（> 20 cm） | 良性多 |
| Endometrioid | 與**子宮內膜異位症**相關；可合併子宮內膜癌 | 約 20% 惡性 |
| Clear cell | 與**子宮內膜異位症**相關；預後差 | 惡性 |
...
- **Endocervical curettage（ECC）**：刮取子宮頸管內膜組織，評估轉化區以上病變
...
### 11.3 骨盆腔器官脫垂（Pelvic Organ Prolapse, POP）
...
### 11.4 尿失禁（Urinary Incontinence, UI）
...
- **擴張介質（distension media）**：
    - **生理食鹽水（normal saline）**：用於 bipolar electrosurgery → 最常用、最安全
        - 過度吸收只會造成水 Volume overload，較不易引發低血鈉症
    - **低黏度非電解質液**（glycine、sorbitol、mannitol）：用於 monopolar electrosurgery
        - 過度吸收可致 **低血鈉（dilutional hyponatremia）**
        - 液體不足量 deficit > 1000–1500 mL 時需警覺 → 嚴重可致腦水腫
