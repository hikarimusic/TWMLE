...
| **Medullary（MTC）** | 3–5% | **C cells → calcitonin**、amyloid deposit、**RET mutation**；25% 遺傳性（MEN 2） | 淋巴 + 血行 | 中等 |
...
- **RAI（I-131）**：
    ...
    - 須在 **TSH 升高**狀態下進行（停用 levothyroxine 或注射 rhTSH）
...
- 術前必須**排除 pheochromocytoma**（尤其 MEN 2）
