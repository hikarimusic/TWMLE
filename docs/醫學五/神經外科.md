...
| 類型 | 結構移位 | 臨床特徵 |
|------|----------|----------|
| **Uncal** | 顳葉鉤回疝入小腦幕切跡 | **同側瞳孔放大（CN III 壓迫）** → 對側偏癱（大腦腳壓迫）；**最常見**且最重要 |
...
- 機制：旋轉加速/減速力 → 軸突剪力損傷
- **CT 常正常**或僅見灰白質交界處、胼胝體、腦幹背側的點狀出血
- MRI（DWI/SWI）比 CT 敏感
...
- **急性處理**：
    ...
    - **機械取栓（Mechanical thrombectomy）**：大血管阻塞（LVO），**發病 6–24 小時**
