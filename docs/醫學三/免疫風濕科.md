...
- **重要片段功能**：
    - **C3a / C5a**：anaphylatoxin（促發炎）；chemotaxis（趨化 neutrophils）
    - **C3b**：opsonization（調理作用，增強吞噬）
- **補體缺乏與疾病**：
    - **C1q / C2 / C4 缺乏** → 與 **SLE** 高度相關（
    - **C3 缺乏** → 反覆嚴重化膿性感染
...
| **Anti-Ro（SS-A）** | Sjögren's、SLE | 與**新生兒狼瘡**、光敏感相關 |
...
- **Anti-Ro（SS-A）**：與光敏感、亞急性皮膚型狼瘡（SCLE）、**新生兒狼瘡**相關
...
| 輕度（皮膚/關節） | H+ 短期低劑量 corticosteroid ± NSAIDs |
...
- **HCQ 副作用**：視網膜病變（bull's eye maculopathy）→ 需定期眼科追蹤（每年一次）
...
- **臨床表現**：
    ...
    - 血小板減少（消耗性）
- **診斷**：至少 1 項臨床標準 + 至少 1 項實驗室標準，且**抗體需間隔 ≥12 週兩次陽性**
- **治療**：
